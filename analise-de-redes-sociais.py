...
# Substitua pelo ID da postagem
INSTAGRAM_MEDIA_ID = "ID_DA_SUA_POSTAGEM"  
...
def preprocess_comments(comments):
    ...
    for comment in comments:
        ...
        # Remover emojis e caracteres especiais (mantendo acentos)
        comment = re.sub(r"[^\w\sáàâãéèêíïóôõöúçñÁÀÂÃÉÈÊÍÏÓÔÕÖÚÇÑ]", "", comment)  
        # Remover números
